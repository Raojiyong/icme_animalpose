...
_C.MODEL.DIM = 2
_C.MODEL.INNER_DIM = 64
_C.MODEL.MULTI_TRANSFORMER_DEPTH = [2, 2]
_C.MODEL.MULTI_TRANSFORMER_HEADS = [8, 8]
...
_C.TRAIN.MODEL_LR = 0.001
_C.TRAIN.JOINTS_LR = 0.01
_C.TRAIN.LR_END = 5e-6
