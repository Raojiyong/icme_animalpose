...
from core.loss import HeatmapLoss, GFL
from core.function import train_cutmix
...
def main():
    ...
    for epoch in range(begin_epoch, cfg.TRAIN.END_EPOCH):
        ...
        # train for one epoch
        train_cutmix(cfg, train_loader, model, criterion_kpt, criterion_part, optimizer, epoch, final_output_dir)

        # evaluate on validation set
        perf_indicator = validate(
            cfg, valid_loader, valid_dataset, model, criterion_kpt,
            final_output_dir, log_type=cfg.LOG_TYPE
        )
        lr_scheduler.step()
